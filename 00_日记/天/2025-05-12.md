...
## 改端口
端口被占用，需要修改对应的docker compose。主要是line 105和161
...
![[../../_assets/img/Pasted image 20250512123350.png]]

之后注册和登录，生成对应的api-key
```python
...
import os
os.environ["LANGFUSE_SECRET_KEY"] = "sk-lf-a054ee04-7f23-4fb4-b38f-c9f489ad012d"
os.environ["LANGFUSE_PUBLIC_KEY"] = "pk-lf-ed7485bc-5a3b-4394-b2a2-c1e37c34b121"
