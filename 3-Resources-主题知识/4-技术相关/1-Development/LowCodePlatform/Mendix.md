...
# 初学之后的心得
1. Mendix主要开发Web app，但这个app，其实指的就是网站开发，包含前后端。其中Domain model代表的数据库建模依然是必须的，还是基于RDBMS。
2. Mendix集合了Agile，CI/CD之类的工作方法和流程进去。
...
7. 但有一说一，目前低代码平台需要一个过程，单纯的数据分析和报表类的已经out了。
8. 突然一个想法，什么叫做低代码，过度的封装并不代表低代码，那chatgpt这种自动生成代码的就叫做低代码了吗？
