...
```txt
/bin：这个目录存放着最经常使用的命令
/sbin：这里存放的是系统管理员使用的系统管理程序.系统预设的执行文件的放置目录，比如 ls 就是在 /bin/ls 目录下的。
...
## 文件结构
![](../../../../../_assets/img/2023-02-22-16-13-33.png)
![](../../../../../_assets/img/2023-02-22-16-23-53.png)
...
ls -l
```
![](../../../../../_assets/img/2023-02-22-16-14-10.png)
权限部分参见[[Linux基础（8 权限管理）]]
## 文件数据
![](../../../../../_assets/img/2023-02-22-16-18-37.png)
...
![](../../../../../_assets/img/2023-02-22-16-20-21.png)
...
```
可以显示所有设备，比如我的外接硬盘
![](../../../../../_assets/img/2023-02-23-11-13-46.png)
...
```
比如这是我的显示
![](../../../../../_assets/img/2023-02-23-11-17-41.png)
就没有这块硬盘
## 挂载命令
```sh
...
df -h
```
![](../../../../../_assets/img/2023-02-23-11-18-39.png)
出现了，挂载成功
