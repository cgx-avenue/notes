...
![[../../../../../_assets/img/Pasted image 20240321132205.png]]
...
```
![[../../../../../_assets/img/Pasted image 20240321095231.png]]

## 频谱滚降点（Spectral Rolloff）

频谱滚降点的意思，我翻译过来大概是：比该频率低的频率的所有能量大于一定比例的整个频谱的能量，通常这个比例为0.85。
![[../../../../../_assets/img/Pasted image 20240321095257.png]]
```python
spectral_rolloff = librosa.feature.spectral_rolloff(x, sr=sr)[0]
librosa.display.waveplot(x, sr=sr, alpha=0.4)
plt.plot(t, normalize(spectral_rolloff), color='r')
```
![[../../../../../_assets/img/Pasted image 20240321101059.png]]
...
![[../../../../../_assets/img/Pasted image 20240321101404.png]]
...
3. https://zhuanlan.zhihu.com/p/365714663