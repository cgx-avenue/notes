...
```
![](../../../_assets/img/2023-02-17-15-50-50.png)
![](../../../_assets/img/2023-02-17-15-50-57.png)
注意：
冒号后面需要一个空格 严格按照格式填写！！！
```txt
wifis:
...
![](../../../_assets/img/2023-02-21-15-18-16.png)
为什么不通过cockpit设置呢？
...
![](../../../_assets/img/2023-02-20-10-06-27.png)
注意：
...
sudo blkid
```
![](../../../_assets/img/2023-02-20-10-19-05.png)
...
df -h
```
![](../../../_assets/img/2023-02-20-10-24-44.png)
重启系统，看是否生效
```sh
sudo reboot
```
![](../../../_assets/img/2023-02-20-10-30-54.png)
搞定
## 开通smb服务
### 树莓派上安装smb
创建需要共享的文件夹（可跳过）
...
```
![](../../../_assets/img/2023-02-20-13-26-11.png)
### Windows上挂载smb
>参照refs7
...
```
测试和查看共享
![](../../../_assets/img/2023-02-20-13-31-53.png)
使用mount挂载
```sh
sudo mount //192.168.1.175/ubuntu /mnt -o username=ubuntu,pass=fastroad
```
![](../../../_assets/img/2023-02-20-13-33-01.png)
设置开机自动挂载
```txt
...
![](../../../_assets/img/2023-02-20-14-13-17.png)
...
![](../../../_assets/img/2023-02-21-10-08-17.png)
...
uname -a
```
![](../../../_assets/img/2023-02-20-15-02-24.png)
如图示就是64位的。
解压下载的压缩包
```sh
...
node -v & npm -v
```
![](../../../_assets/img/2023-02-20-15-12-04.png)
...
```
输入 pm2 查看是否成功
![](../../../_assets/img/2023-02-20-15-26-10.png)
查看当前运行项目
```sh
pm2 list
```
...
```
![](../../../_assets/img/2023-02-20-15-34-26.png)
根据图里提示，复制命令并回车
```sh
...
```
重启树莓派后如下图，设置成功
![](../../../_assets/img/2023-02-20-15-37-50.png)

### mind-map
https://github.com/wanglin2/mind-map
没跑起来，npm i 了之后不知道怎么跑
...
![](../../../_assets/img/2023-02-20-16-16-45.png)
并在auth里选中
![](../../../_assets/img/2023-02-20-16-19-11.png)
copy账户里加入的这个network id，树莓派里运行如下命令（3e开头的就是network id）
```sh
sudo zerotier-cli join 3efa5cb78a494324
```
![](../../../_assets/img/2023-02-24-11-07-46.png)

这时候再到zerotier网页端就能看到有ip了
![](../../../_assets/img/2023-02-24-11-08-17.png)
配置开机启动，就搞定了
```sh
...
```
输出如下
![](../../../_assets/img/2023-02-23-10-13-14.png)
...
![](../../../_assets/img/2023-02-23-11-06-26.png)
...
![](../../../_assets/img/2023-02-23-11-10-54.png)
