...
For a smooth handover,  our Mattias was asking me about this yesterday, but I think now the machine in Yixing is stable and knowledge part, for sure I would do the transition once Mattias appointed the successor.
...
# Checklist
* [x] 删除chrome，清空history
* [x] 删掉剩余的工作文件夹
* [x] 备份cherry-studio，之后删掉
* [x] 删掉obsidian和notes文件夹
* [x] 检查各种目录和软件，该删除的删
