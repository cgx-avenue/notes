...
```
这时候portainer的container已经可以显示这个容器了。ubuntu主机端使用dbvear-ce建立连接并访问，如图
...
```
树莓派ip:18083 访问
	首次登录admin, public，之后admin，fastroad12345

### home-assistant
安装失败，哪天再重试吧
https://blog.csdn.net/weixin_43909881/article/details/126136328
