...
使用mount挂载
```sh
sudo mount //192.168.1.141/ubuntu /mnt -o username=ubuntu,pass=fastroad
```
![](../imgs/2023-02-20-13-33-01.png)
设置开机自动挂载
```txt
//192.168.1.141/ubuntu /mnt/external cifs username=ubuntu,password=fastroad 0 0
```
...
```
![](imgs/2023-02-24-11-07-46.png)

这时候再到zerotier网页端就能看到有ip了
![](imgs/2023-02-24-11-08-17.png)
配置开机启动，就搞定了
```sh
